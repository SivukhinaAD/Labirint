...
void RayCastingWindow::render()
{
	...
	SDL_SetRenderDrawColor(_renderer.get(), 30, 144, 255, 255);
	...
	double a = _player -> dir(); //Íàïðàâëåíèå âçãëÿäà
	...
	SDL_SetRenderDrawColor(_renderer.get(), 199, 21, 133, 255);
